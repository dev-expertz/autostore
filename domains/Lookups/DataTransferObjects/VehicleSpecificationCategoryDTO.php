...
use WebApi\Database\Models\VehicleSpecificationCategory;

class VehicleSpecificationCategoryDTO implements IJSONResponse
{
    public int $id;
    public string $name;
    ...
    public static function fromDBModel(VehicleSpecificationCategory $model): self
    {
