...
use WebApi\Database\Models\VehicleTransmission;

class VehicleTransmissionDTO implements IJSONResponse
{
    public int $id;
    public string $name;
    ...
    public static function fromDBModel(VehicleTransmission $model): self
    {
