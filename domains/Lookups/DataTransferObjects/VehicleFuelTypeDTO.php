...
use WebApi\Database\Models\VehicleFuelType;

class VehicleFuelTypeDTO implements IJSONResponse
{
    public int $id;
    public string $name;
    ...
    public static function fromDBModel(VehicleFuelType $model): self
    {
